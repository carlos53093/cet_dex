...
async function main() {
  ...
  // Verify cryptoInterfaceMulticall
  console.log('Verify cryptoInterfaceMulticall')
  await verifyContract(deployedContracts_v3_periphery.CryptoInterfaceMulticall)
  await sleep(10000)
