...
contract MCV3Test is MasterChefV3 {
    ...
    constructor(IERC20 _crypto, INonfungiblePositionManager _nonfungiblePositionManager, address _WETH) MasterChefV3(_crypto, _nonfungiblePositionManager, _WETH) {}
