...
library SmartRouterHelper {
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0xa7dc4f65ef1fe5b8ed871098490ea653098752b9adf1cb2f2664dcf9c4095df0;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0x4df55b716c4860761850d688a7522eee33a4b056dbe088d6f002a236eb9b6b56;
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (ICryptoV3Pool) {
        return ICryptoV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (ICryptoV3Pool pool) {
    ...
    {
        pool = ICryptoV3Pool(computeAddress(deployer, poolKey));
