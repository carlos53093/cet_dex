...
/// @title NFT positions
/// @notice Wraps Crypto V3 positions in the ERC721 non-fungible token interface
contract NonfungiblePositionManager is
    ...
    SelfPermit
{
    // details about the crypto position
    struct Position {
    ...
    ) ERC721Permit('Crypto V3 Positions NFT-V1', 'PCS-V3-POS', '1') PeripheryImmutableState(_deployer, _factory, _WETH9) {
